...
const projects = [
  {
    ...
    pills: ["109K+ events tracked", "4,357 creators", "Live A/B experiment"],
  ...
  },
  {
    ...
    pills: ["50% query deflection", "750 creators", "v2 shipped post-monitoring"],
    slug: "wishii",
  },
  {
    ...
    pills: ["86+ conversations scored", "5-dimension rubric", "Automated Slack alerts"],
    slug: "chatqc",
  },
];
